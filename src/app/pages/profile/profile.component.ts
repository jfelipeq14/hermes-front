...
import { bloodTypes, typesDocument, sexlist, epslist } from '../../shared/constants';

@Component({
    selector: 'app-profile',
    standalone: true,
    imports: [CommonModule, FormsModule, ButtonModule, InputTextModule, DropdownModule, CalendarModule, ToastModule, ProgressSpinnerModule, ConfirmDialogModule],
    providers: [ProfileService, MunicipalityService, MessageService, ConfirmationService],
...
export class ProfileComponent implements OnInit {
    ...
    cancelEdit(): void {
        this.confirmationService.confirm({
            message: '¿Está seguro de que desea cancelar la edición? Se perderán los cambios no guardados.',
            header: 'Confirmación',
