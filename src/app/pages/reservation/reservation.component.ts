...
import { ReservationsService, ProgrammingService, ClientsService, AuthService } from '../../services';
import { PackageModel, PaymentModel, ReservationModel, UserModel } from '../../models';
...
@Component({
    ...
    imports: [CommonModule, StepperModule, ButtonModule, CardModule, BreadcrumbModule, FormClientsComponent, FormTravelersComponent, FormPaymentsComponent],
    providers: [ReservationsService, ProgrammingService, ClientsService, AuthService, MessageService]
})
